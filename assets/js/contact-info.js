...
const init = async (countries) => {
    ...
    const setNewSelected = (prefix, flag) => {
        ...
        selectedFlag.src = `https://www.worldometers.info/img/flags/${flag}-flag.gif`;
    ...
    const createList = () =>
        new Promise((resolve, _) => {
            countries.forEach((country, index, countries) => {
                ...
                const element = `<li class="pn-list-item ${flag === "in" ? "pn-list-item--selected" : ""
                    } js_pn-list-item" data-flag="${flag}" data-prefix="${prefix}" tabindex="0" role="button" aria-pressed="false">
          <img class="pn-list-item__flag" src="https://www.worldometers.info/img/flags/${flag}-flag.gif" />
